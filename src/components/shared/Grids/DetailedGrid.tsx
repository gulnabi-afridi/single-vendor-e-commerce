...
const DetailedGrid: React.FC<Props> = ({
  Title,
  TableHeaders,
  GridCols,
  children,
    ...
    <div className="w-full bg-[#F7F7F7] border-[1px] border-[#D1D9E2] rounded-[8px] Shadow">
      ...
      <div className="w-full flex items-center justify-between border-b-[2px] border-gray p-4">
        ...
        <div className="w-[300px] flex items-center justify-center">
          ...
          />
          <button className="h-[40px] w-[40px] flex items-center justify-center rounded-r-[5px] text-white-main bg-black-soft border-[3px] border-black-main">
            <BiSearch size={20} />
          </button>
        </div>
      </div>
      <div className="w-full overflow-auto HideScroll">
        ...
        >
          {TableHeaders.map((item: string, index: any) => (
            <div
              key={index}
              className="w-full font-medium text-black-main text-[13px] font-inter"
            >
